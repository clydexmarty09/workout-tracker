        ...
        <main className="bg-black text-white min-h-screen">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm"> 
             ...
             <div className="flex justify-between">
                    ...
                    className="disabled:opacity-40 disabled:hover-scale-100 text-sm w-45 transition hover:scale-105 active:scale-95 rounded-xl bg-green-500 py-2 font-semibold text-black"> 
                        Resume Workout
                    </button>
                    ...
                    onClick={stopWorkout}
                    disabled={!activeSession}
                    className="disabled:opacity-40 disabled:hover-scale-100 text-sm w-45 transition hover:scale-105 active:scale-95 rounded-xl bg-red-400 py-2 font-semibold text-black"> 
                        Stop Workout
                    </button>
